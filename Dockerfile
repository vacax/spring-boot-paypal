...
COPY --from=build /home/gradle/src/build/libs/*.jar /app/springboot-paypal.jar
ENTRYPOINT ["java", "-Djava.security.egd=file:/dev/./urandom","-jar","/app/springboot-paypal.jar"]